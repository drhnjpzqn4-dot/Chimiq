...
export * from "./patchShelfProductRequest";
...
export * from "./scanProductNameRequest";
export * from "./scanProductNameRequestMimeType";
export * from "./scanProductNameResponse";
export * from "./scanProductNameResponseConfidence";
export * from "./shelfProduct";
export * from "./shelfProductAnalysisResultJson";
