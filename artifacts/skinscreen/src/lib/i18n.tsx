...
const en: Dict = {
  ...
  "myShelf.filter.slotBoth": "AM + PM",
  "myShelf.emptyAll": "No products on your shelf yet.",
  "myShelf.emptySlotBoth": "No products tagged for both morning and evening.",
  "myShelf.addFirstAny": "Add your first product below.",
  "myShelf.addFirstSlotBoth": "When adding a product, choose both morning and evening.",
...
const sv: Dict = {
  ...
  "myShelf.filter.slotBoth": "Båda",
  "myShelf.emptyAll": "Inga produkter på din hylla ännu.",
  "myShelf.emptySlotBoth": "Inga produkter markerade för både morgon och kväll.",
  "myShelf.addFirstAny": "Lägg till din första produkt nedan.",
  "myShelf.addFirstSlotBoth": "Välj både morgon och kväll när du lägger till produkten.",
...
const fr: Dict = {
  ...
  "myShelf.filter.slotBoth": "Matin + soir",
  "myShelf.emptyAll": "Aucun produit sur votre étagère pour le moment.",
  "myShelf.emptySlotBoth": "Aucun produit programmé matin et soir.",
  "myShelf.addFirstAny": "Ajoutez votre premier produit ci-dessous.",
  "myShelf.addFirstSlotBoth": "Lors de l’ajout, choisissez matin et soir.",
...
const es: Dict = {
  ...
  "myShelf.filter.slotBoth": "Mañana + noche",
  "myShelf.emptyAll": "Aún no hay productos en tu estante.",
  "myShelf.emptySlotBoth": "No hay productos marcados para mañana y noche.",
  "myShelf.addFirstAny": "Añade tu primer producto abajo.",
  "myShelf.addFirstSlotBoth": "Al añadir, elige mañana y noche.",
